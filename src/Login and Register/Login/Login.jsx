...
const Login = () => {
    ...
    return (
        <div className="bg-[#fae8d3] shadow8 py-5 lg:pl-[115px] lg:ml-[450px] md:ml-0 m-10 rounded-3xl w-[600px]">
            <div className=" md:w-1/3 mt-10 mb-10">
                ...
                <div className="relative">
                    <button
                        ...
                        className="cursor-pointer w-[352px] py-2 px-4 border-2 rounded-md border-gray-300 bg-white text-base font-semibold">Continue With GitHub</button>
